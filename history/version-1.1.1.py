...
#  
# Copyleft liyang JLU Physics 2017
#
...
def player_guide_interface():
  ...
  print("                      Copyleft liyang@phys.jlu                 ")
  print("                                                               ")
  ...
  while True:
    ...
    observe_every_evolution = str(input('>>> '))
...
def dla_data_saved(enable_periodic_map, dla_data_length, dla_data_width,
  ...
  print('| Final Pattern:                %s' % filename_pic)
  print('|-------------------------------------------------------------')
  print('>>> Data Saved!!! <<<')
...
def main():
  ...
  ### DLA Data Part Set ###
  dla_data = DlaData(dla_data_length, dla_data_width, init_nuclei_coor_array, enable_periodic_map)
  ### DLA Plot Part Set ###
